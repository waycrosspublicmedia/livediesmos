...
function onUpdatePost()
    ...
    setPropertyFromClass('lime.app.Application', 'current.window.title', 'FNF VS ROSS V2 '..'Currently Playing: '..getProperty('curSong')..' By: Bonky | '..getProperty('scoreTxt.text'))
    end
end
function onDestroy()
    songended = true
